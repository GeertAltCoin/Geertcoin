...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Geertcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"geertcoin.com", "dnsseed.geertcoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"geertcoin.com", "testnet-seed.geertcoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Geertcoin is probably already running."), addrBind.ToString().c_str());
        else
